...
export default function Ch4(props) {
    ...
    function sceneControl() {
        switch (scene) {
            case -3:
                return <GotItemScreen onNext={props.onNext} item={4} />
            case -2:
            ...
            case 0:
                return (
                    <ScenePage image_path={sceneImage[0]} previousScene={previousScene} nextScene={nextScene} chapter={4} />
                )
            case 1:
                return (
                    <ScenePage image_path={sceneImage[1]} previousScene={previousScene} nextScene={nextScene} chapter={4} />
                )
            case 2:
                return (
                    <ScenePage image_path={sceneImage[2]} previousScene={previousScene} nextScene={nextScene} chapter={4} />
                )
            case 3:
                return (
                    <ScenePage image_path={sceneImage[3]} previousScene={previousScene} nextScene={nextScene} chapter={4} />
                )
            case 4:
                return (
                    <ScenePage image_path={sceneImage[4]} previousScene={previousScene} nextScene={nextScene} chapter={4} />
                )
            case 5:
                return (
                    <ScenePage image_path={sceneImage[5]} previousScene={previousScene} nextScene={nextScene} chapter={4} />
                )
            case 6:
                return (
                    <ScenePage image_path={sceneImage[6]} previousScene={previousScene} nextScene={nextScene} chapter={4} />
                )
            case 7:
                return (
                    <ScenePage image_path={sceneImage[7]} previousScene={previousScene} nextScene={nextScene} chapter={4} />
                )
            case 8:
                return (
                    <>
                        <ScenePage image_path={sceneImage[8]} previousScene={previousScene} nextScene={onOpenQuestion} chapter={4} />
                        <Modal
                            open={modalOpen}
                        >
                            <Grid
